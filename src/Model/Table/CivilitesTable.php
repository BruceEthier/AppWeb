 ...
 * @method \App\Model\Entity\Civilite|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Civilite saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
