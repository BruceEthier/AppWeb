    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('date_faite') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $employesFormation->has('employe') ? $this->Html->link($employesFormation->employe->id, ['controller' => 'Employes', 'action' => 'view', $employesFormation->employe->id]) : '' ?></td>
                <td><?= $employesFormation->has('formation') ? $this->Html->link($employesFormation->formation->id, ['controller' => 'Formations', 'action' => 'view', $employesFormation->formation->id]) : '' ?></td>
                <td><?= h($employesFormation->date_faite) ?></td>
                <td><?= h($employesFormation->remarques) ?></td>
                <td><?= h($employesFormation->created) ?></td>
                <td><?= h($employesFormation->modified) ?></td>
                <td class="actions">
